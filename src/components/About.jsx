      ...
      <div className="container about-grid">
        <div className="about-content">
          ...
          <h2>Reliable Travel Partner for Your Every Destination</h2>
            At Royal Travels, we pride ourselves on delivering a premium transportation experience across South India. 
            With years of excellence in the regional travel industry, we understand the importance of safety, 
            comfort, and punctuality. Our mission is to provide seamless travel solutions 
            for families, corporates, and solo travelers alike, covering all major destinations in the region.
